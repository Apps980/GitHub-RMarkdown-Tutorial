...
=======
The issue that happened here is that one person committed a change, and others do not have that change (yet). To get around this, pull first, then commit and push. More importantly, communicate with your collaborators! Tell them when you are trying to push something so that someone else doesn't push at the same time. 
>>>>>>> 4a421d5ab54eac1a22f04b53a567d9f0253730de
